...
1. Download the [latest version](https://github.com/Basico-PS/AutomationOrchestrator/archive/v0.0.6.zip).
...
3. Unzip the folder in your created "Automation Orchestrator" folder. So, your path could be similar to "C:\Automation Orchestrator\AutomationOrchestrator-0.0.6.zip" or "C:\Program Files\Automation Orchestrator\AutomationOrchestrator-0.0.6.zip". However, you may unzip the folder anywhere on your system.
