...
class Botflow(models.Model):
    ...
    queued_notification = models.CharField(max_length=255, blank=True, help_text="Specify who (if any) should receive an email notification when the botflow is queued. To specify multiple emails, use comma to separate them like this: 'abc@email.dk, xyz@email.dk'.")
    started_notification = models.CharField(max_length=255, blank=True, help_text="Specify who (if any) should receive an email notification when the botflow is started. To specify multiple emails, use comma to separate them like this: 'abc@email.dk, xyz@email.dk'.")
    completed_notification = models.CharField(max_length=255, blank=True, help_text="Specify who (if any) should receive an email notification when the botflow is completed. To specify multiple emails, use comma to separate them like this: 'abc@email.dk, xyz@email.dk'.")
    error_notification = models.CharField(max_length=255, blank=True, help_text="Specify who (if any) should receive an email notification when the botflow fails. To specify multiple emails, use comma to separate them like this: 'abc@email.dk, xyz@email.dk'. IMPORTANT: This will not include errors during the execution of the botflow.")
